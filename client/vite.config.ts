  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          {
            src: 'assets/favicon-32x32.png?v=artdent-20260922',
            sizes: '32x32',
            type: 'image/png',
          },
          {
            src: 'assets/favicon-16x16.png?v=artdent-20260922',
            sizes: '16x16',
            type: 'image/png',
          },
          {
            src: 'assets/apple-touch-icon-180x180.png?v=artdent-20260922',
            sizes: '180x180',
            type: 'image/png',
          },
          {
            src: 'assets/icon-192x192.png?v=artdent-20260922',
            sizes: '192x192',
            type: 'image/png',
          },
          {
            src: 'assets/maskable-icon.png?v=artdent-20260922',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'maskable',
          },
